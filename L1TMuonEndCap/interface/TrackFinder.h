...
private:
  ...
  const edm::EDGetToken tokenCSC_, tokenCSCComparator_, tokenRPC_, tokenCPPF_, tokenGEM_, tokenIRPC_, tokenME0_;

  int verbose_, primConvLUT_;

  bool fwConfig_, useCSC_, useRPC_, useCPPF_, useGEM_, useIRPC_, useME0_;
